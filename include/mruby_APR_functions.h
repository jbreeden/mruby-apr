...
#define BIND_apr_file_mtime_set_FUNCTION TRUE
...
#define BIND_apr_time_exp_gmt_FUNCTION TRUE
#define BIND_apr_time_exp_gmt_get_FUNCTION FALSE
#define BIND_apr_time_exp_lt_FUNCTION TRUE
#define BIND_apr_time_exp_tz_FUNCTION TRUE
#define BIND_apr_time_now_FUNCTION TRUE
#define BIND_apr_time_sec_FUNCTION TRUE
