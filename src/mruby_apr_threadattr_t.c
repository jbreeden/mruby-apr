...
mrb_value
mrb_APR_AprThreadattrT_disown(mrb_state* mrb, mrb_value self) {
...
mrb_value
mrb_APR_AprThreadattrT_belongs_to_ruby(mrb_state* mrb, mrb_value self) {
  mrb_value ruby_object;
  mrb_get_args(mrb, "o", &ruby_object);
...
#endif
  mrb_define_class_method(mrb, AprThreadattrT_class, "disown", mrb_APR_AprThreadattrT_disown, MRB_ARGS_ARG(1, 0));
  mrb_define_class_method(mrb, AprThreadattrT_class, "belongs_to_ruby?", mrb_APR_AprThreadattrT_belongs_to_ruby, MRB_ARGS_ARG(1, 0));
